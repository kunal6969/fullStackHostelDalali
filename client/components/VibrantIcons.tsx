...
const CheckBadgePath: React.FC = () => <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M9 14.25l2.25 2.25 4.5-4.5" />;
export const CheckBadgeIcon = withGlow(CheckBadgePath, '#34D399', 'grad-green-cyan');

const ChartPiePath: React.FC = () => <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15 7.5 7.5 0 000-15zm0 0v7.5h7.5m-7.5 0L21 21M3 3l9 9" />;
export const ChartPieIcon = withGlow(ChartPiePath, '#FF00FF', 'grad-fuchsia-purple');

const TrashPath: React.FC = () => <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />;
...
export const XMarkIcon = withGlow(XMarkPath, '#DC143C', 'grad-pink-red');